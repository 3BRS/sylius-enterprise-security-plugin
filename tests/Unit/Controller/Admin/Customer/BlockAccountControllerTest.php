...
use ThreeBRS\SyliusEnterpriseSecurityPlugin\Controller\Admin\Customer\BlockAccountController;
use ThreeBRS\SyliusEnterpriseSecurityPlugin\Service\Session\CustomerSessionTrackerInterface;

#[CoversClass(BlockAccountController::class)]
class BlockAccountControllerTest extends TestCase
{
    public function testDisablesUserAndRevokesAllSessions(): void
    {
    ...
    {
        $controller = $this->createController(null, $this->createStub(CustomerSessionTrackerInterface::class), validToken: true);
    ...
    private function createController(
        ...
        return new BlockAccountController($customerRepository, $tracker, $csrf, $router);
    }
