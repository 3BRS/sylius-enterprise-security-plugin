...
namespace ThreeBRS\SyliusEnterpriseSecurityBundle\Validator\Constraint;
...
{
    public string $policyGroup = 'default';
    ...
    {
        return 'three_brs.bundle.validator.password_policy';
    }
}
