...
#[ORM\Entity(repositoryClass: CustomerPasswordHistoryRepository::class)]
#[ORM\Table(name: 'three_brs_customer_password_history')]
class CustomerPasswordHistory implements CustomerPasswordHistoryInterface
{
    #[ORM\Id]
