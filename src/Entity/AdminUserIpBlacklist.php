...
use ThreeBRS\SyliusEnterpriseSecurityPlugin\Repository\AdminUserIpBlacklistRepository;

#[ORM\Entity(repositoryClass: AdminUserIpBlacklistRepository::class)]
#[ORM\Table(name: 'three_brs_admin_user_ip_blacklist')]
#[ORM\UniqueConstraint(name: 'uniq_admin_user_ip_blacklist_admin', columns: ['admin_user_id'])]
class AdminUserIpBlacklist implements AdminUserIpBlacklistInterface
{
    #[ORM\Id]
