...
Feature: Admin user password policy
    ...
    Scenario: Administrator cannot be created with a password that is too short
        ...
        When I specify their email as "admin@example.com"
        And I specify their username as "newadmin"
    ...
    Scenario: Administrator password can be changed to a strong password
        Given there is an administrator with email "existing@example.com"
        When I want to modify this administrator
