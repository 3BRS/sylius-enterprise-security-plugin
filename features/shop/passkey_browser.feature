...
Feature: Passkey ceremonies through the browser
    ...
    @javascript
    Scenario: A registered passkey signs the customer back in
        Given the customer "passkey-browser@example.com" can sign in with the password "Pass1Word!"
        And a virtual authenticator is attached to the browser
        And I sign in to the shop in the browser as "passkey-browser@example.com" with password "Pass1Word!"
        And I register a passkey labelled "Virtual Touch ID" in the browser
        And I sign out in the browser
        When I sign in to the shop in the browser with a passkey
        Then I should be signed in to the shop in the browser as "passkey-browser@example.com"
